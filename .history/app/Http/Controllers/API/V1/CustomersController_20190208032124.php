...
class CustomersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($customer_type == 'person'){ //if inserting person
            ...
            $var = $this->storeCustomerDetails($request['customers'], $new_person_id, $customer_type, $customer_category);
            return $var;
        }
    ...
    public function storeCustomerDetails($passed_request, $new_id, $customer_type, $customer_category)
    {      
        $request = new Request($passed_request);
        
        $request->query->add(['customer_details_id' => $new_id,'customer_type' => $customer_type,'customer_category' => $customer_category]);
        // dd($request);
