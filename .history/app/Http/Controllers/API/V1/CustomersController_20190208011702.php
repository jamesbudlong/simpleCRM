...
class CustomersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($customer_type == 'person'){ //if inserting person
            ...
            $this->storeCustomerDetails($request['customers'], $new_person_id, $customer_type);
        }
    ...
    {
        $request2 = new Request($passed_request);
        dd($request2);
        $customer = Customer::create($request2['query']['parameters']::all() + ['customer_details_id' => $new_id, 'customer_type' => $customer_type]);
        return "success";
    }
