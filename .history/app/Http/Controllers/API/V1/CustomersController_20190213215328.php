...
class CustomersController extends Controller
{
    ...
    public function index()
    {
        ...
        $customers = Customer::select('cust.*')
            ->leftJoin('users.*', 'cust.responsible_seller', '=', 'users.id')
            ->get();
        //$customers = Customer::select('cust.*')->leftJoin('users', 'users.id', '=', 'cust.responsible_seller');
