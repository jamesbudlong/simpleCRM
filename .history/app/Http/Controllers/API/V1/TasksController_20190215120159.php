...
class TasksController extends Controller
{
    ...
    public function index()
    {
        $results = DB::table('tasks')
            ...
            ->select('tasks.*','users.id as user_id','users.name as user_name','customers.id as customer_id','customers.first_name as first_name','customers.last_name as last_name','customers.company_name as company_name')
            ->get();

        $customers = $results->paginate(10);
