...
class CustomersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($customer_type == 'person'){ //if inserting person
            ...
            $this->storeCustomerDetails($request, $new_person_id);
        }
    ...
    public function storeCustomerDetails(Request $request, $new_id)
    {
        dd($request);
        $customer = Customer::create($request->customers->all() + ['customer_details_id' => $new_id]);
        return $customer;
    }
