...
class CustomersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($customer_type == 'person'){ //if inserting person
            ...
            $var = $this->storeCustomerDetails($request['customers'], $new_person_id, $customer_type, $customer_category, $responsible_user);
            return $var;
        }
    ...
    public function storeCustomerDetails($passed_request, $new_id, $customer_type, $customer_category, $responsible_user)
    {      
