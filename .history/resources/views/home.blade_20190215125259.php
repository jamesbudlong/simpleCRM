...
<router-view name="customers_profile"></router-view>
<router-view name="companies_create"></router-view>
<router-view name="persons_create"></router-view>
<router-view name="exploration"></router-view>
<router-view name="pipeline"></router-view>
<router-view name="pipeline_create"></router-view>
<router-view name="pipeline_view"></router-view>
