                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form v-on:submit="saveForm()">        
                                    ...
                                    <input type="text" v-model="customer_categories.category" class="form-control col-md-6 form-group">
                               
                                    <label class="control-label">Category Name</label>
                                    <input type="text" v-model="customer_categories.category" class="form-control col-md-3 form-group">
