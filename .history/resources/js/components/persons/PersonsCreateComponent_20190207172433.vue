                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <!-- <div class="col-sm-6 form-group">
                                            ...
                                            <input type="text" v-model="customer.customer_number" class="form-control">
                                        </div> -->
                                        <div class="col-sm-3 form-group">
                                            <label class="control-label">Category</label>
                                            <!-- <input type="text" v-model="customer_categories.customer_category" class="form-control"> -->
                                            <select v-model="customer.customer_category" class="form-control">
                                        ...
                                        <!-- <div class="col-sm-3 form-group">
                                            ...
                                            <input type="text" v-model="customer.responsible_user" class="form-control">
                                        </div> -->
                                    </div>
                                    <!-- <div class="row">
                                        <div class="col-sm-6 form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 form-group">
                                            ...
                                            <textarea rows="3" v-model="customer.general_comment" class="form-control" style="resize: none;"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input type="text" v-model="customer.mailing_address" class="form-control">
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label class="control-label">Visiting Address</label>
                                            <input type="text" v-model="customer.visiting_address" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-2 form-group">
                                            <label class="control-label">Zip Code</label>
                                            <input type="text" v-model="customer.ma_zip_code" class="form-control">
                                        </div>
                                        <div class="col-sm-4 form-group">
                                            <label class="control-label">Place</label>
                                            <input type="text" v-model="customer.ma_place" class="form-control">
                                        </div>
                                        <div class="col-sm-2 form-group">
                                            <label class="control-label">Zip Code</label>
                                            <input type="text" v-model="customer.va_zip_code" class="form-control">
                                        </div>
                                        <div class="col-sm-4 form-group">
                                            <label class="control-label">Place</label>
                                            <input type="text" v-model="customer.va_place" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label class="control-label">Country</label>
                                            <input type="text" v-model="customer.ma_country" class="form-control">
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label class="control-label">Country</label>
                                            <input type="text" v-model="customer.va_country" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group">
                                            ...
                                            <input type="text" v-model="customer.telephone" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4 form-group">
