                        ...
                        <div class="card-body">
                            <form v-on:submit="saveForm()">        
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" v-model="customer_categories.category" class="form-control col-md-6">
                              
                                    <label class="control-label">Category Name</label>
                                    <input type="text" v-model="customer_categories.category" class="form-control col-md-3">
