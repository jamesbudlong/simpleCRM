        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item"><router-link :to="{name: 'pipelines'}">Pipeline</router-link></li>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a v-on:click="showContacts = true;" class="nav-link" id="contacts-tab" data-toggle="tab" href="#contacts" role="tab" aria-controls="contacts" aria-selected="false"><i class="fa fa-user"></i> Contacts (0)</a>
                                                </li>
                                                <li class="nav-item">
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="tab-pane fade" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
                                                    <!-- contacts here -->
                                                    <contacts-index v-if="showContacts"></contacts-index>
                                                </div>
                                ...
                                <div class="card-body col-md-4">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <router-link :to="{name: 'pipeline_create'}" class="btn btn-sm btn-success pull-right"><i class="fa fa-plus" aria-hidden="true"></i> New Opportunity</router-link>
                                            </div>
                                            <br /><br />
                                            <div class="table-responsive">
                                                ...
                                                <tbody>
                                                    <tr v-for="pipeline, index in pipelines">
                                                        <td>{{ pipeline.status }}</td>
                                                        <td>
                                                            <router-link :to="{name: 'pipeline_view', params: {id: pipeline.id}}">
                                                                {{ pipeline.name }}
                                                            </router-link>
                                                        </td>
                                                        <td>{{ pipeline.probability }} <br /> kr {{pipeline.value}}</td>
                                                    </tr>
                                                </tbody>
                                                </table>
                                            </div>
