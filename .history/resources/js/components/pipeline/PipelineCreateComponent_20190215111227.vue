                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input type="text" v-model="pipelines.first_name" class="form-control">
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label class="control-label">Lastname</label>
                                            <input type="text" v-model="pipelines.last_name" class="form-control">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 form-group">
                                            ...
                                            <textarea rows="3" v-model="pipelines.general_comment" class="form-control" style="resize: none;"></textarea>
                                        </div>
                                    </div>
