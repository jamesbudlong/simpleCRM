                            ...
                            <div class="row">
                                ...
                                <div class="card-body col-md-4">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            Name: {{pipelines.first_name}} {{pipelines.last_name}} {{pipelines.company_name}}
                                            <br />
                                            Address: {{pipelines.visiting_address}}{{pipelines.zipcode}}{{pipelines.place}}{{pipelines.country}}
                                            <br />
                                            Telephone:
                                            <br />
                                            E-Mail:
