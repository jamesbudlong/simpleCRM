                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <router-link :to="{name: 'customers_profile', params: {id: cust_id}}" class="btn btn-dark pull-right"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</router-link>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
    ...
    export default {
        ...
        methods: {
            ...
            saveForm() {
                ...
                var newArrayPipeline = {newPipeline,customer_id};
                axios.post('/api/v1/pipelines', newArrayPipeline)
                    .then(function (resp) {
                        Vue.swal({
                            position: 'center',
                            type: 'success',
                    ...
                    .catch(function (resp) {
                        ...
                        Vue.swal({
                            position: 'center',
                            type: 'error',
                            title: 'Something went wrong! Cannot add pipeline..',
                            showConfirmButton: false,
                            timer: 2000
                        });
                    });
