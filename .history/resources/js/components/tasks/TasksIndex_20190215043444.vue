    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div v-if="seen3"> <!-- edit task form -->
                <form v-on:submit="updateTaskForm(tasksEdit.id)">   
                    <div class="card-body col-md-12">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label class="control-label">Responsible User</label>
                                <select v-model="tasksEdit.responsible_seller" class="form-control" required>
                                    <option v-for="user in users" v-bind:value="user.id">
                                        {{user.name}}
                                    </option>
                                </select>  
                            ...
                            <div class="col-md-6 form-group">
                                <label class="control-label">Status</label>
                                <select v-model="tasksEdit.status" class="form-control" required>
                                    <option value="not_started">Not Started</option>
                                    <option value="started">Started</option>
                                    <option value="done">Done</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label class="control-label">Priority</label>
                                <select v-model="tasksEdit.priority" class="form-control" required>
                                    <option value="low">Low</option>
                                    <option value="normal">Normal</option>
                                    <option value="high">High</option>
                                </select>
                            ...
                            <div class="col-md-6 form-group">
                                <label class="control-label">Decay</label>
                                <date-picker name="date" v-model="tasksEdit.decay" :config="datetimepicker_options" required></date-picker>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <label class="control-label">Comment</label>
                                <textarea rows="3" v-model="tasksEdit.comment" class="form-control" style="resize: none;"></textarea>
                            </div>
                        </div>
                        <div class="col-xs-12 form-group">
...
export default {
    ...
    methods: {
        ...
        updateTaskForm(task_id) {
            ...
            axios.patch('/api/v1/contacts/' + task_id, newTaskUpdate)
                .then(function (resp) {
                    Vue.swal({
                        position: 'center',
                        type: 'success',
