                    ...
                    <div class="card-body col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <date-picker name="date" v-model="tasksAdd.decay" :config="datetimepicker_options"></date-picker>
                            </div>
                        </div>
                        <div class="row">
...
export default {
    ...
    methods: {
        ...
        saveTaskForm(seen) {
            ...
            var newContacts = {tasksAdd,customer_id};

            axios.post('/api/v1/tasks', newContacts)
                .then(function (resp) {
                    Vue.swal({
                        position: 'center',
                        type: 'success',
