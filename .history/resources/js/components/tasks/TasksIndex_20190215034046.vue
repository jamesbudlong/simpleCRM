                    ...
                    <div class="card-body col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <!-- <input type="text" v-model="tasksAdd.decay" class="form-control"> -->
                                <date-picker name="date" v-model="tasksAdd.decay" :config="options"></date-picker>
                            </div>
                        </div>
                        <div class="row">
...
Vue.component('date-picker', require('VueBootstrapDatetimePicker'));
