<template>
    <div class="card">
        <div class="card-header">
            ...
            <button class="btn btn-dark pull-right backButton" v-on:click="seen = !seen; this.getContacts(this.$route.params.id);" v-if="!seen"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button>
        </div>
        <div class="card-body">
