<template>
    <div class="card">
        <div class="card-header">
            ...
            <button class="btn btn-dark pull-right backButton" v-on:click="seen1 = true; seen2 = false" v-if="seen2 || seen3"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        <tr v-for="contact, index in contactsList">
                            ...
                            <td>
                                ...
                                <a href="#" class="btn btn-primary" v-on:click="seen3 = true; seen1 = false">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"> Edit</i>
                                </a>
