<template>
    <div class="card">
        <div class="card-header">
            <button class="btn btn-success pull-right" v-on:click="seen = !seen" v-if="seen || !seen2"><i class="fa fa-plus" aria-hidden="true"></i> Create</button>
            <button class="btn btn-dark pull-right backButton" v-on:click="seen = !seen;" v-if="!seen && seen2"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button>
            <button class="btn btn-dark pull-right backButton" v-on:click="seen = !seen;" v-if="!seen2"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button>
        </div>
        <div class="card-body">
            <div v-if="seen && seen2"><!-- contacts view -->
                    ...
                    <tbody>
                        <tr v-for="contact, index in contactsList">
                            ...
                            <td>
                                ...
                                <a href="#" class="btn btn-primary" v-on:click="seen2 = !seen2 ">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"> Edit</i>
                                </a>
            ...
            <div v-if="!seen2"> <!-- add contact form -->
                <form v-on:submit="updateContactForm()">   
                    <div class="card-body col-md-12">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label class="control-label">Firstname</label>
