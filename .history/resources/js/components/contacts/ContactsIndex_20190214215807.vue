<template>
    <div class="card">
        <div class="card-header">
            ...
            <button class="btn btn-dark pull-right backButton" v-on:click="seen1 = true; seen2 = false" v-if="!seen1 || !seen3"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button>
        </div>
        <div class="card-body">
