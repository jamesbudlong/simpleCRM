<template>
    <div class="card">
        <div class="card-header">
            <button class="btn btn-success pull-right" v-on:click="seen1 = !seen1; seen2 = true; seen3 = !seen3" v-if="seen1"><i class="fa fa-plus" aria-hidden="true"></i> Create</button>
            <button class="btn btn-dark pull-right backButton" v-on:click="seen1 = !seen1;" v-if="!seen1"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        <tr v-for="contact, index in contactsList">
                            ...
                            <td>
                                ...
                                <a href="#" class="btn btn-primary" v-on:click="seen2 = !seen2; seen = !seen">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"> Edit</i>
                                </a>
