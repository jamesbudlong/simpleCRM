        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item" @click="changeMenu()"><router-link :to="{name: 'dashboard'}">Dashboard</router-link></li>
                        ...
                        <div class="card-body">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <pagination :data="customer_categories" @pagination-change-page="getResults"></pagination>
                                </div>
                            </div>
                        </div>
                        <!-- ./card-body -->
