                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <router-link :to="{name: 'customer_categories_create'}" class="btn btn-success pull-right"><i class="fa fa-plus" aria-hidden="true"></i>Add</router-link>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <div class="panel-body">
                                    ...
                                    <tbody>
                                        <tr v-for="customer_category, index in customer_categories">
                                            ...
                                            <td>
                                                <router-link :to="{name: 'customer_categories_edit', params: {id: customer_category.id}}" class="btn btn-md btn-primary">
                                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                </router-link>
                                                <a href="#" class="btn btn-md btn-danger" v-on:click="deleteEntry(customer_category.id, index)">
