                                ...
                                <div class="panel-body">
                                    ...
                                    <tbody>
                                        <tr v-for="customer_category, index in customer_categories">
                                            ...
                                            <td>
                                                <router-link :to="{name: 'customer_categories_edit', params: {id: customer_category.id}}" class="btn btn-lg btn-primary">
                                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                </router-link>
                                                <a href="#" class="btn btn-lg btn-danger" v-on:click="deleteEntry(customer_category.id, index)">
