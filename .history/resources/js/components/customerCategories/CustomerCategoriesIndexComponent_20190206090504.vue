                        ...
                        <div class="card-body">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <tbody>
                                        <!-- <tr v-for="customer_category in customer_categories.data"> -->
                                            <tr v-for="customer_category, index in customer_categories.data.data">
                                    ...
                                    <pagination :data="customer_categories.data" @pagination-change-page="getResults"></pagination>
                                </div>
                            </div>
                        </div>
                        <!-- ./card-body -->
        ...
        methods: {
            getResults(page = 1) {
                axios.get('/api/v1/customerCategory?page=' + page)
                    .then(response => {
                        this.customer_categories = json_decode(response.data);
                    });
            },
