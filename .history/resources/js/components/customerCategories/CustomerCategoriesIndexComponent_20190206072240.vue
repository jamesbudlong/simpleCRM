                                ...
                                <div class="panel-body">
                                    ...
                                    <tbody>
                                        <tr v-for="customer_category, index in customer_categories">
                                            ...
                                            <td>
                                                <router-link :to="{name: 'customer_categories_edit', params: {id: customer_category.id}}" class="pull-left">
                                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                </router-link>
                                                <a href="#" class="pull-right" v-on:click="deleteEntry(customer_category.id, index)">
