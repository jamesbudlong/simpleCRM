                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input type="text" v-model="customers.company_name" class="form-control">
                                        </div>
                                        <div class="col-sm-3 form-group">
                                            <label class="control-label">Company Number</label>
                                            <input type="text" v-model="customers.company_number" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-3 form-group">
                                            <label class="control-label">Industry</label>
                                            <input type="text" v-model="customers.industry" class="form-control">
                                        ...
                                        <div class="col-sm-3 form-group">
                                            ...
                                            <input type="text" v-model="customers.company_type" class="form-control">
                                        ...
                                        <div class="col-sm-3 form-group">
                                            ...
                                            <select v-model="responsible_seller" class="form-control">
                                                <option v-for="user in users" v-bind:value="user.id">
                                                    {{user.name}}
                                                </option>
                                            </select>  
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 form-group">
                                            ...
                                            <input type="email" v-model="customers.email" class="form-control">
                                        </div>
                                        <div class="col-sm-4 form-group">
