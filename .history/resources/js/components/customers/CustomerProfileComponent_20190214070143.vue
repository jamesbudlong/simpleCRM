                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div v-if="!seen"> <!-- add contact form -->
                                                                <form v-on:submit="saveContactForm(contacts.id)">   
    ...
    export default {
        ...
        methods: {
            saveContactForm(id) {
                ...
                var app = this;
                var newContacts = app.contacts;
                
                var a = this.$set(this.newContacts, 'customer_id', id);
                
                //var a = newContacts.set(newContacts[], 'name', id);
