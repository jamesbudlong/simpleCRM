                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    {{ customers.created_at }} by {{ customers.created_by }}
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    {{ customers.updated_at }} by {{ customers.updated_by }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                responsible_seller: null,
                category: null
            }
        },
        methods: {
            getCategory() {
                axios.get('/api/v1/customerCategory/getCategory' + id)
                    .then(function (resp) {
                    ...
                    .catch(function () {
                        Vue.swal({
                            position: 'center',
                            type: 'error',
                            title: 'Something went wrong! Cannot get category..',
                            showConfirmButton: false,
                            timer: 2000
                        });
                    });
