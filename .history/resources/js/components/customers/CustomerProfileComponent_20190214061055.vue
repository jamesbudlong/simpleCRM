                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="tab-pane fade" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <button class="btn btn-success pull-right" v-on:click="seen = !seen" v-if="seen">New Contact</button>
                                                            <button class="btn btn-success pull-right" v-on:click="seen = !seen" v-if="!seen">Back</button>
                                                        </div>
                                                        <div class="card-body">
                                                           <div v-if="seen">Message Can Be Seen!</div>
                                                        </div>
                                                    </div>
                                                </div>
