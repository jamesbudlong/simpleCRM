                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" id="contacts-tab" data-toggle="tab" href="#contacts" role="tab" aria-controls="contacts" aria-selected="false" v-on:click="getContacts(customers.id)"><i class="fa fa-user"></i> Contacts (0)</a>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <div class="tab-pane fade" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            ...
                                                            <button class="btn btn-dark pull-right" v-on:click="seen = !seen; getContacts(customers.id)" v-if="!seen"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button>
                                                        </div>
                                                        <div class="card-body">
                                                            <div v-if="seen"><!-- contacts view -->
                                                                <router-view name="contacts_index"></router-view>
                                                            </div>
