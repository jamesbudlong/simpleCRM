                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        <i class="fa fa-list icon-fixed-width"></i>asd
                                                    </div>
                                                    <div class="row">
                                                        <i class="fa fa-phone icon-fixed-width"></i>asd
                                                    </div>
                                                    <div class="row">
                                                        <i class="fa fa-mobile icon-fixed-width"></i>asd
                                                    </div>
                                                    <div class="row">
                                                        <span><i class="fa fa-globe icon-fixed-width"></i>asd</span>
                                                    </div>
                                                    <div class="row">
                                                        <i class="fa fa-envelope icon-fixed-width"></i>asd
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
