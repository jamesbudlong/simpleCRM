                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        <i class="fa fa-list icon-fixed-width">asd</i>
                                                    </div>
                                                    <div class="row">
                                                        <i class="fa fa-phone icon-fixed-width">asd</i>
                                                    </div>
                                                    <div class="row">
                                                        <i class="fa fa-mobile icon-fixed-width">asd</i>
                                                    </div>
                                                    <div class="row">
                                                        <i class="fa fa-globe icon-fixed-width">asd</i>
                                                    </div>
                                                    <div class="row">
                                                        <i class="fa fa-phone icon-fixed-width">asd</i>
                                                    </div>
