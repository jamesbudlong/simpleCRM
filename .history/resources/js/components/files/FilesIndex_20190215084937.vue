                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        <tr v-for="get_file, index in get_files">
                            ...
                            <td><img :src="'/public/files/uploads/' + get_file.path + '/' + get_file.filename"/> </td>
                            <td><a :href="'/public/files/uploads/' + get_file.path + '/' + get_file.filename">{{ get_file.filename }}</a></td>
