                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        <tr v-for="get_file, index in get_files">
                            ...
                            <td><img src="/storage/files/uploads/2dbaf5d831b591d8a5d74ca4b5646bb0bbfc377b6ee1d8ae71497efad3d9dba9/1.jpg">test</a></td>
                            <!-- <td><a href='files/' + {{get_file.path}} + '/' + {{get_file.filename}} + '/'> {{get_file.filename }} </a></td> -->
