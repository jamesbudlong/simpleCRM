...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="navbar-nav">
                        <router-link :to="{ name: 'example' }" class="nav-link">Home</router-link>
                        <router-link :to="{ name: 'test' }" class="nav-link" >Spa-Page</router-link>
                    </ul>
            ...
            <!-- Add icons to the links using the .nav-icon class
                ...
                <li class="nav-item ">
                    ...
                    <p>
                        <router-link :to="{ name: 'example' }">Dashboardss</router-link>
                    </p>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <p>
                        <router-link :to="{ name: 'test' }">History</router-link>
                    </p>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link">
