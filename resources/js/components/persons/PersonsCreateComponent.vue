                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input type="text" v-model="customers.first_name" class="form-control" required>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label class="control-label">Lastname</label>
                                            <input type="text" v-model="customers.last_name" class="form-control" required>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group">
                                            ...
                                            <input type="text" v-model="customers.website" class="form-control" required>
                                        </div>
                                        <div class="col-sm-4 form-group">
