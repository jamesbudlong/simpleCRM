                        ...
                        <div class="card-body">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                        ...
                                        <tbody>
                                            <tr v-for="pipeline, index in pipelines.data">
                                                ...
                                                <td>
                                                 ...
                                                 <td v-if="pipeline.customer_type == 'person'">
                                                    <router-link :to="{name: 'customers_profile', params: {id: pipeline.customer_id}}">
                                                        {{ pipeline.first_name }} {{ pipeline.last_name }}
                                                    </router-link>
                                                </td>
                                                <td v-else>
                                                    <router-link :to="{name: 'customers_profile', params: {id: pipeline.customer_id}}">
                                                ...
                                                <td>
                                                    <router-link :to="{name: 'users_view', params: {id: pipeline.user_id}}">
                                                        {{ pipeline.user_name }}
                                                    </router-link>
                                                </td>
                                                <td>kr {{ pipeline.value }}</td>
                                    ...
                                    <pagination :data="pipelines" @pagination-change-page="getPipelines"></pagination>
                                </div>
                            </div>
                        </div>
                        <!-- ./card-body -->
