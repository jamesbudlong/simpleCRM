...
<script>
    import TasksPipelineIndex from '../pipeline/TasksPipelineIndex'
    import FilesPipelineIndex from '../pipeline/FilesPipelineIndex'
    ...
    export default {
        ...
        components: {
            'tasks-index': TasksPipelineIndex,
            'files-index': FilesPipelineIndex
        }
    }
</script>